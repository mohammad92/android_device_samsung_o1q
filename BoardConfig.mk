...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/o1q/prebuilt/Image.gz
TARGET_PREBUILT_DTB := device/samsung/o1q/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/o1q/prebuilt/recovery_dtbo
...
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/o1q/bootimg.mk
...
# Dynamic Partitions
BOARD_SUPER_PARTITION_SIZE := 12574523392
